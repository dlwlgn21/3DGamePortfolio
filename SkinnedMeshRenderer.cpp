...
{
	//mClipKeys.reserve(static_cast<UINT>(BoneAnimator::eCharacterAnimState::COUNT));
...
//{
	...
	//	{
	//		meState = BoneAnimator::eCharacterAnimState::IDLE_TO_WALK;
	//		frameCount = 0;
	//	}
	...
	//	{
	//		meState = BoneAnimator::eCharacterAnimState::WALK_FORWARD;
	//		frameCount = 0;
	//	}
	//	break;
	//}
	...
	//		if (InputManager::GetKeyState(eKeyCode::UP) != eKeyState::PRESSED)
	//		{
	//			meState = BoneAnimator::eCharacterAnimState::WALK_TO_IDLE;
	//		}
	//		frameCount = 0;
	//	}
	//	break;
	...
	//	if (animData.ClipMap[mClipKeys[clipIndex]].IsLastFrame(frameCount))
	//	{
	//		meState = BoneAnimator::eCharacterAnimState::IDLE;
	//		frameCount = 0;
	//	}
	//	break;
	//}
