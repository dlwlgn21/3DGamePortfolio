...
void MonsterScript::Initialize()
{
	...
	mpStates[static_cast<UINT>(eMonsterState::TRACING)] = new jh::fsm::MonsterTracingState(this);
	mpStates[static_cast<UINT>(eMonsterState::ATTACKING)] = new jh::fsm::MonsterAttackingState(this);
