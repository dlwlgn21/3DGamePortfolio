...
namespace debug_draw
{
        ...
        FXMVECTOR color)
    {
        ...
        debug_draw::DrawRing(batch, origin, xaxis, zaxis, color);
        debug_draw::DrawRing(batch, origin, xaxis, yaxis, color);
        debug_draw::DrawRing(batch, origin, yaxis, zaxis, color);
    }
        ...
        FXMVECTOR color)
    {
        ...
        debug_draw::DrawCube(batch, matWorld, color);
    }
